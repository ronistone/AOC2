...
ARCHITECTURE structure OF example24 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \Mux6~0_combout\ = (\SW[1]~input_o\ & (!\SW[3]~input_o\ & ((!\SW[0]~input_o\) # (!\SW[2]~input_o\)))) # (!\SW[1]~input_o\ & (\SW[3]~input_o\ $ ((\SW[2]~input_o\))))
...
-- Equation(s):
-- \Mux3~0_combout\ = (\SW[2]~input_o\ & ((\SW[3]~input_o\) # (\SW[1]~input_o\ $ (!\SW[0]~input_o\)))) # (!\SW[2]~input_o\ & ((\SW[1]~input_o\ & (\SW[3]~input_o\)) # (!\SW[1]~input_o\ & ((\SW[0]~input_o\)))))
...
-- Equation(s):
-- \Mux1~0_combout\ = (\SW[3]~input_o\ & ((\SW[1]~input_o\) # ((\SW[2]~input_o\)))) # (!\SW[3]~input_o\ & (\SW[2]~input_o\ & (\SW[1]~input_o\ $ (\SW[0]~input_o\))))
...
-- Equation(s):
-- \Mux0~0_combout\ = (\SW[1]~input_o\ & (\SW[3]~input_o\)) # (!\SW[1]~input_o\ & (\SW[2]~input_o\ $ (((!\SW[3]~input_o\ & \SW[0]~input_o\)))))
