...
ARCHITECTURE structure OF exercise32 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \Selector0~0_combout\ = (\b~input_o\ & ((\state.S1~q\) # ((!\state.S0~q\ & \a~input_o\)))) # (!\b~input_o\ & (((!\state.S0~q\ & \a~input_o\))))
...
-- Equation(s):
-- \nextstate.S2~0_combout\ = (\b~input_o\ & \state.S1~q\)
