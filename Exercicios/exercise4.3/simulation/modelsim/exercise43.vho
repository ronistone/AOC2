...
-- Design Ports Information
-- LEDR	=>  Location: PIN_P2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- SW[2]	=>  Location: PIN_M2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[3]	=>  Location: PIN_M1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \LEDR~0_combout\ = \SW[0]~input_o\ $ (\SW[1]~input_o\ $ (\SW[2]~input_o\ $ (\SW[3]~input_o\)))
