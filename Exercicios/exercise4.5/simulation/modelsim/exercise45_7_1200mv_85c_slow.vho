...
ARCHITECTURE structure OF exercise45 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \LEDR~0_combout\ = (\SW[2]~input_o\ & (!\SW[0]~input_o\ & !\SW[1]~input_o\)) # (!\SW[2]~input_o\ & (\SW[0]~input_o\ $ (\SW[1]~input_o\)))
