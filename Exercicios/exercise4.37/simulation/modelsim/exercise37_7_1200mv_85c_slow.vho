...
ARCHITECTURE structure OF exercise37 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \Mux1~0_combout\ = (\state[0]~_Duplicate_1_q\ & ((!\state[2]~_Duplicate_1_q\))) # (!\state[0]~_Duplicate_1_q\ & (\state[1]~_Duplicate_1_q\))
...
-- Equation(s):
-- \state[1]~_Duplicate_1feeder_combout\ = \Mux1~0_combout\
...
-- Equation(s):
-- \Mux0~0_combout\ = (\state[0]~_Duplicate_1_q\ & ((\state[2]~_Duplicate_1_q\))) # (!\state[0]~_Duplicate_1_q\ & (\state[1]~_Duplicate_1_q\))
...
-- Equation(s):
-- \state[2]~_Duplicate_1feeder_combout\ = \Mux0~0_combout\
...
-- Equation(s):
-- \Mux2~0_combout\ = \state[2]~_Duplicate_1_q\ $ (!\state[1]~_Duplicate_1_q\)
