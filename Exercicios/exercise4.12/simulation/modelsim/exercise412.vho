...
ARCHITECTURE structure OF exercise412 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \LEDR~1_combout\ = (!\SW[1]~input_o\ & \SW[0]~input_o\)
...
-- Equation(s):
-- \LEDR~0_combout\ = (!\SW[4]~input_o\ & (!\SW[6]~input_o\ & (!\SW[5]~input_o\ & !\SW[7]~input_o\)))
...
-- Equation(s):
-- \LEDR~2_combout\ = (\LEDR~1_combout\ & (\LEDR~0_combout\ & (!\SW[2]~input_o\ & !\SW[3]~input_o\)))
...
-- Equation(s):
-- \LEDR~3_combout\ = (!\SW[3]~input_o\ & (\LEDR~0_combout\ & (!\SW[2]~input_o\ & \SW[1]~input_o\)))
...
-- Equation(s):
-- \LEDR~4_combout\ = (!\SW[3]~input_o\ & (\SW[2]~input_o\ & \LEDR~0_combout\))
...
-- Equation(s):
-- \LEDR~5_combout\ = (\LEDR~0_combout\ & \SW[3]~input_o\)
...
-- Equation(s):
-- \LEDR~6_combout\ = (\SW[4]~input_o\ & (!\SW[6]~input_o\ & (!\SW[5]~input_o\ & !\SW[7]~input_o\)))
...
-- Equation(s):
-- \LEDR~7_combout\ = (!\SW[6]~input_o\ & (\SW[5]~input_o\ & !\SW[7]~input_o\))
...
-- Equation(s):
-- \LEDR~8_combout\ = (\SW[6]~input_o\ & !\SW[7]~input_o\)
