...
-- Design Ports Information
-- ledr[0]	=>  Location: PIN_V1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- ledr[3]	=>  Location: PIN_U7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sw[8]	=>  Location: PIN_T8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sw[17]	=>  Location: PIN_AC3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sw[4]	=>  Location: PIN_Y3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sw[16]	=>  Location: PIN_AA4,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF example46 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \ledr~0_combout\ = (\sw[16]~input_o\ & ((\sw[4]~input_o\) # ((\sw[17]~input_o\)))) # (!\sw[16]~input_o\ & (((\sw[0]~input_o\ & !\sw[17]~input_o\))))
...
-- Equation(s):
-- \ledr~1_combout\ = (\sw[17]~input_o\ & ((\ledr~0_combout\ & (\sw[12]~input_o\)) # (!\ledr~0_combout\ & ((\sw[8]~input_o\))))) # (!\sw[17]~input_o\ & (((\ledr~0_combout\))))
...
-- Equation(s):
-- \ledr~2_combout\ = (\sw[17]~input_o\ & ((\sw[9]~input_o\) # ((\sw[16]~input_o\)))) # (!\sw[17]~input_o\ & (((!\sw[16]~input_o\ & \sw[1]~input_o\))))
...
-- Equation(s):
-- \ledr~3_combout\ = (\sw[16]~input_o\ & ((\ledr~2_combout\ & (\sw[13]~input_o\)) # (!\ledr~2_combout\ & ((\sw[5]~input_o\))))) # (!\sw[16]~input_o\ & (((\ledr~2_combout\))))
...
-- Equation(s):
-- \ledr~4_combout\ = (\sw[16]~input_o\ & (((\sw[6]~input_o\) # (\sw[17]~input_o\)))) # (!\sw[16]~input_o\ & (\sw[2]~input_o\ & ((!\sw[17]~input_o\))))
...
-- Equation(s):
-- \ledr~5_combout\ = (\sw[17]~input_o\ & ((\ledr~4_combout\ & (\sw[14]~input_o\)) # (!\ledr~4_combout\ & ((\sw[10]~input_o\))))) # (!\sw[17]~input_o\ & (((\ledr~4_combout\))))
...
-- Equation(s):
-- \ledr~6_combout\ = (\sw[17]~input_o\ & ((\sw[11]~input_o\) # ((\sw[16]~input_o\)))) # (!\sw[17]~input_o\ & (((!\sw[16]~input_o\ & \sw[3]~input_o\))))
...
-- Equation(s):
-- \ledr~7_combout\ = (\sw[16]~input_o\ & ((\ledr~6_combout\ & ((\sw[15]~input_o\))) # (!\ledr~6_combout\ & (\sw[7]~input_o\)))) # (!\sw[16]~input_o\ & (((\ledr~6_combout\))))
