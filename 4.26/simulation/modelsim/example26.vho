...
ARCHITECTURE structure OF example26 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \LEDR~1_combout\ = (!\SW[3]~input_o\ & (\SW[1]~input_o\ & !\SW[2]~input_o\))
...
-- Equation(s):
-- \LEDR~2_combout\ = (!\SW[3]~input_o\ & \SW[2]~input_o\)
